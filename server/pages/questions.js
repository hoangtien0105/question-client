...
/* harmony import */ var constants_seo__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1040);
...
function QuestionNews({ data , page , answers , randomQuestions  }) {
    var ref;
...
const getStaticProps = async (ctx)=>{
    try {
        const data = await lib_api_requester__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getSync */ .ZP.getSync(`/questions?page=1`);
        ...
        const randomQuestions = await lib_api_requester__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getSync */ .ZP.getSync(`/randomquestion`);
        return {
            props: {
                data: data,
                page: 1,
...
var __webpack_exports__ = __webpack_require__.X(0, [699,676,664,322,437], () => (__webpack_exec__(2511)));
