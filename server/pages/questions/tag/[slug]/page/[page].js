...
async function getStaticPaths() {
    const data = await lib_api_requester__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getSync */ .ZP.getSync(`/getalltagslugbypagination`);
    const paths = [];
...
var __webpack_exports__ = __webpack_require__.X(0, [952,664,408,108,437], () => (__webpack_exec__(537)));
