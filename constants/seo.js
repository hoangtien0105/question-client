export const siteName = 'Solution Checker';
export const siteDescription = 'Find the solution to any question. We focus on finding the fastest possible solution for users. Main topics like coding, learning.'
